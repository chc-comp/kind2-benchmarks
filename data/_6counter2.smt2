...
(rule (=> 
  (and (= top.ni_0._arrow._first_m top.ni_0._arrow._first_c)(and (= top.__top_1 (ite top.ni_0._arrow._first_m true false))
       ...
       (and (or (not (= top.__top_1 false))
               (and (= top.c (or (and top.__top_4_c (not top.__top_2_c)) (and top.__top_3_c top.__top_2_c)))
                    (= top.b (or (and (and (not top.__top_4_c) (not top.__top_3_c)) top.__top_2_c) (and top.__top_3_c (not top.__top_2_c))))
                    (= top.a (not top.__top_2_c))
                    ))
