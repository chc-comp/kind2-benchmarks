...
; Abs
(declare-var Abs.X Int)
(declare-var Abs.Abs Int)
(declare-rel Abs_fun (Int Int))
; Stateless step rule 
(rule (=> 
  (and (or (not (= (< Abs.X 0) true))
          (= Abs.Abs (- Abs.X)))
       (or (not (= (< Abs.X 0) false))
          (= Abs.Abs Abs.X))
  )
  (Abs_fun Abs.X Abs.Abs)
))
...
; Stateless step rule 
(rule (=> 
  (= excludes4.excludes (not (or (or (or (or (and (and (and excludes4.X1 excludes4.X2) excludes4.X1) excludes4.X3) (and excludes4.X1 excludes4.X4)) (and excludes4.X2 excludes4.X3)) (and excludes4.X2 excludes4.X4)) (and excludes4.X3 excludes4.X4))))
...
(declare-var mesi.ni_2._arrow._first_c Bool)
...
(declare-var mesi.ni_2._arrow._first_m Bool)
...
(declare-var mesi.ni_2._arrow._first_x Bool)
...
(rule (=> 
  (and 
       ...
       (= mesi.ni_2._arrow._first_m true)
  )
  (mesi_reset mesi.__mesi_2_c
              mesi.__mesi_3_c
              mesi.__mesi_4_c
              mesi.__mesi_5_c
              mesi.ni_2._arrow._first_c
              mesi.__mesi_2_m
              mesi.__mesi_3_m
              mesi.__mesi_4_m
              mesi.__mesi_5_m
              mesi.ni_2._arrow._first_m)
))
...
(rule (=> 
  (and (= mesi.garde_me4 (>= mesi.__mesi_2_c 1))
       ...
       (= mesi.ni_2._arrow._first_m mesi.ni_2._arrow._first_c)(and (= mesi.__mesi_1 (ite mesi.ni_2._arrow._first_m true false))
                                                                   (= mesi.ni_2._arrow._first_x false))
...
(declare-var top.ni_1.mesi.__mesi_2_c Int)
(declare-var top.ni_1.mesi.__mesi_3_c Int)
(declare-var top.ni_1.mesi.__mesi_4_c Int)
(declare-var top.ni_1.mesi.__mesi_5_c Int)
(declare-var top.ni_1.mesi.ni_2._arrow._first_c Bool)
(declare-var top.ni_0.Sofar.__Sofar_2_m Bool)
(declare-var top.ni_0.Sofar.ni_3._arrow._first_m Bool)
(declare-var top.ni_1.mesi.__mesi_2_m Int)
(declare-var top.ni_1.mesi.__mesi_3_m Int)
(declare-var top.ni_1.mesi.__mesi_4_m Int)
(declare-var top.ni_1.mesi.__mesi_5_m Int)
(declare-var top.ni_1.mesi.ni_2._arrow._first_m Bool)
(declare-var top.ni_0.Sofar.__Sofar_2_x Bool)
(declare-var top.ni_0.Sofar.ni_3._arrow._first_x Bool)
(declare-var top.ni_1.mesi.__mesi_2_x Int)
(declare-var top.ni_1.mesi.__mesi_3_x Int)
(declare-var top.ni_1.mesi.__mesi_4_x Int)
(declare-var top.ni_1.mesi.__mesi_5_x Int)
(declare-var top.ni_1.mesi.ni_2._arrow._first_x Bool)
(declare-var top.__top_1 Int)
(declare-var top.__top_2 Int)
(declare-var top.__top_3 Int)
(declare-var top.__top_4 Int)
...
(declare-rel top_reset (Bool Bool Int Int Int Int Bool Bool Bool Int Int Int Int Bool))
(declare-rel top_step (Bool Bool Bool Bool Bool Bool Bool Int Int Int Int Bool Bool Bool Int Int Int Int Bool))

(rule (=> 
  (and 
       
       (mesi_reset top.ni_1.mesi.__mesi_2_c top.ni_1.mesi.__mesi_3_c
                   top.ni_1.mesi.__mesi_4_c top.ni_1.mesi.__mesi_5_c
                   top.ni_1.mesi.ni_2._arrow._first_c
                   top.ni_1.mesi.__mesi_2_m top.ni_1.mesi.__mesi_3_m
                   top.ni_1.mesi.__mesi_4_m top.ni_1.mesi.__mesi_5_m
                   top.ni_1.mesi.ni_2._arrow._first_m)
  ...
  (top_reset top.ni_0.Sofar.__Sofar_2_c
             top.ni_0.Sofar.ni_3._arrow._first_c
             top.ni_1.mesi.__mesi_2_c
             top.ni_1.mesi.__mesi_3_c
             top.ni_1.mesi.__mesi_4_c
             top.ni_1.mesi.__mesi_5_c
             top.ni_1.mesi.ni_2._arrow._first_c
             top.ni_0.Sofar.__Sofar_2_m
             top.ni_0.Sofar.ni_3._arrow._first_m
             top.ni_1.mesi.__mesi_2_m
             top.ni_1.mesi.__mesi_3_m
             top.ni_1.mesi.__mesi_4_m
             top.ni_1.mesi.__mesi_5_m
             top.ni_1.mesi.ni_2._arrow._first_m)
))

; Step rule 
(rule (=> 
  (and (and (= top.ni_1.mesi.__mesi_2_m top.ni_1.mesi.__mesi_2_c)
            (= top.ni_1.mesi.__mesi_3_m top.ni_1.mesi.__mesi_3_c)
            (= top.ni_1.mesi.__mesi_4_m top.ni_1.mesi.__mesi_4_c)
            (= top.ni_1.mesi.__mesi_5_m top.ni_1.mesi.__mesi_5_c)
            (= top.ni_1.mesi.ni_2._arrow._first_m top.ni_1.mesi.ni_2._arrow._first_c)
            )
       (mesi_step top.etat_me1
                  ...
                  top.ni_1.mesi.__mesi_5_m
                  top.ni_1.mesi.ni_2._arrow._first_m
                  top.ni_1.mesi.__mesi_2_x
                  top.ni_1.mesi.__mesi_3_x
                  top.ni_1.mesi.__mesi_4_x
                  top.ni_1.mesi.__mesi_5_x
                  top.ni_1.mesi.ni_2._arrow._first_x)
       ...
       (Abs_fun top.modified_me
                top.__top_4)
       (Abs_fun top.exclusive_me
                top.__top_3)
       (Abs_fun top.shared_me
                top.__top_2)
       (Abs_fun top.invalid_me
                top.__top_1)
       (= top.OK (=> top.env (<= (+ (+ (+ top.__top_4 top.__top_3) top.__top_2) top.__top_1) 3)))
       )
...
(declare-rel MAIN (Bool Bool Int Int Int Int Bool Bool))
; Initial set: Reset(c,m) + One Step(m,x) 
(declare-rel INIT_STATE ())
(rule INIT_STATE)
(rule (=> 
  (and INIT_STATE
       (top_reset top.ni_0.Sofar.__Sofar_2_c top.ni_0.Sofar.ni_3._arrow._first_c top.ni_1.mesi.__mesi_2_c top.ni_1.mesi.__mesi_3_c top.ni_1.mesi.__mesi_4_c top.ni_1.mesi.__mesi_5_c top.ni_1.mesi.ni_2._arrow._first_c top.ni_0.Sofar.__Sofar_2_m top.ni_0.Sofar.ni_3._arrow._first_m top.ni_1.mesi.__mesi_2_m top.ni_1.mesi.__mesi_3_m top.ni_1.mesi.__mesi_4_m top.ni_1.mesi.__mesi_5_m top.ni_1.mesi.ni_2._arrow._first_m)
       (top_step top.etat_me1 top.etat_me2 top.etat_me3 top.etat_me4 top.OK top.ni_0.Sofar.__Sofar_2_m top.ni_0.Sofar.ni_3._arrow._first_m top.ni_1.mesi.__mesi_2_m top.ni_1.mesi.__mesi_3_m top.ni_1.mesi.__mesi_4_m top.ni_1.mesi.__mesi_5_m top.ni_1.mesi.ni_2._arrow._first_m top.ni_0.Sofar.__Sofar_2_x top.ni_0.Sofar.ni_3._arrow._first_x top.ni_1.mesi.__mesi_2_x top.ni_1.mesi.__mesi_3_x top.ni_1.mesi.__mesi_4_x top.ni_1.mesi.__mesi_5_x top.ni_1.mesi.ni_2._arrow._first_x)
  )
  (MAIN top.ni_0.Sofar.__Sofar_2_x top.ni_0.Sofar.ni_3._arrow._first_x top.ni_1.mesi.__mesi_2_x top.ni_1.mesi.__mesi_3_x top.ni_1.mesi.__mesi_4_x top.ni_1.mesi.__mesi_5_x top.ni_1.mesi.ni_2._arrow._first_x top.OK)
))

; Inductive def
(declare-var dummytop.OK Bool)
(rule (=> 
  (and (MAIN top.ni_0.Sofar.__Sofar_2_c top.ni_0.Sofar.ni_3._arrow._first_c top.ni_1.mesi.__mesi_2_c top.ni_1.mesi.__mesi_3_c top.ni_1.mesi.__mesi_4_c top.ni_1.mesi.__mesi_5_c top.ni_1.mesi.ni_2._arrow._first_c dummytop.OK)
       (top_step top.etat_me1 top.etat_me2 top.etat_me3 top.etat_me4 top.OK top.ni_0.Sofar.__Sofar_2_c top.ni_0.Sofar.ni_3._arrow._first_c top.ni_1.mesi.__mesi_2_c top.ni_1.mesi.__mesi_3_c top.ni_1.mesi.__mesi_4_c top.ni_1.mesi.__mesi_5_c top.ni_1.mesi.ni_2._arrow._first_c top.ni_0.Sofar.__Sofar_2_x top.ni_0.Sofar.ni_3._arrow._first_x top.ni_1.mesi.__mesi_2_x top.ni_1.mesi.__mesi_3_x top.ni_1.mesi.__mesi_4_x top.ni_1.mesi.__mesi_5_x top.ni_1.mesi.ni_2._arrow._first_x)
  )
  (MAIN top.ni_0.Sofar.__Sofar_2_x top.ni_0.Sofar.ni_3._arrow._first_x top.ni_1.mesi.__mesi_2_x top.ni_1.mesi.__mesi_3_x top.ni_1.mesi.__mesi_4_x top.ni_1.mesi.__mesi_5_x top.ni_1.mesi.ni_2._arrow._first_x top.OK)
))
