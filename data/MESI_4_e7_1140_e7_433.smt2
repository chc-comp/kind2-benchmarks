...
; Stateless step rule 
(rule (=> 
  (= excludes4.excludes (not (or (or (or (or (or (or excludes4.X1 excludes4.X2) (and excludes4.X1 excludes4.X3)) (and excludes4.X1 excludes4.X4)) (and excludes4.X2 excludes4.X3)) (and excludes4.X2 excludes4.X4)) (and excludes4.X3 excludes4.X4))))
...
(rule (=> 
  (and (and (= top.ni_1.mesi.__mesi_2_m top.ni_1.mesi.__mesi_2_c)
       ...
       (Sofar_step (and top.__top_1 (>= top.modified_me 0))
                   top.env
                   top.ni_0.Sofar.__Sofar_2_m
                   top.ni_0.Sofar.ni_3._arrow._first_m
                   top.ni_0.Sofar.__Sofar_2_x
                   top.ni_0.Sofar.ni_3._arrow._first_x)
       (= top.OK (=> top.env (or (<= top.modified_me 1) (<= top.shared_me 1))))
       )
