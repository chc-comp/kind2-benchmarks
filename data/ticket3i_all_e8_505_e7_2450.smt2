...
(rule (=> 
  (and (= ticket3i.g7 (= ticket3i.__ticket3i_7_c 0))
       ...
       (and (or (not (= (or (and (>= ticket3i.p1 3) (>= ticket3i.p2 3)) (>= ticket3i.p3 3)) true))
               (= ticket3i.erreur_ticket3i true))
            (or (not (= (or (and (>= ticket3i.p1 3) (>= ticket3i.p2 3)) (>= ticket3i.p3 3)) false))
...
(rule (=> 
  (and (excludes9_fun top.e1
       ...
       (= top.OK (=> top.env (and (and (and (and (and (and (and (not top.erreur_ticket3i) (<= 0 top.p1)) (<= top.p1 3)) (<= 0 top.p2)) (<= top.p2 3)) (<= 0 top.p3)) (<= top.p3 3)) (<= (+ (+ top.p1 top.p2) top.p3) 9))))
       )
  (top_step top.e1
            top.e2
            top.e3
