...
(rule (=> 
  (and (= top.ni_0._arrow._first_m top.ni_0._arrow._first_c)(and (= top.__top_1 (ite top.ni_0._arrow._first_m true false))
       ...
       (= top.OK (or (and (>= top.rlt_enter_microwave_mode_logic_rlt_state_2_states___root 1) (<= top.rlt_enter_microwave_mode_logic_rlt_state_2_states___root 3)) (= top.rlt_enter_microwave_mode_logic_rlt_state_2_states___root 4)))
       )
