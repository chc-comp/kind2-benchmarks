...
(rule (=> 
  (and (= DRAGON.g11 (>= DRAGON.__DRAGON_4_c 1))
       ...
       (= DRAGON.g02 (and (>= DRAGON.__DRAGON_2_c 1) (>= (+ (+ (- (+ (- DRAGON.__DRAGON_3_c 1) DRAGON.__DRAGON_6_c) 1) DRAGON.__DRAGON_5_c) DRAGON.__DRAGON_4_c) 1)))
...
(rule (=> 
  (and (excludes12_fun top.e01
       ...
       (= top.OK (=> top.env (and (>= top.exclusive 0) (>= top.shared 0))))
       )
  (top_step top.e01
            top.e02
            top.e03
