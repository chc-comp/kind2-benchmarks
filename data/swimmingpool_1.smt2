...
(rule (=> 
  (and (and (= top.ni_3.swimingpool.__swimingpool_10_m top.ni_3.swimingpool.__swimingpool_10_c)
       ...
       (= top.OK (=> (and (and (and (and top.__top_4 (<= 0 top.__top_2)) (<= 0 top.__top_1)) (< top.__top_2 1000)) (< top.__top_1 1000)) (<= (+ (+ (+ (+ (+ (+ top.x1 top.x2) top.x3) top.x4) top.x5) top.x6) top.x7) (+ top.p1 top.p2))))
       )
  (top_step top.e1
            top.e2
            top.e3
