...
(rule (=> 
  (and (excludes12_fun top.e01
       ...
       (= top.OK (and (and (and (and (and (and (and (and (and (and (and (and (and (=> top.env (not top.erreur)) (=> top.env top.__top_4)) (=> top.env (= (+ (+ (+ (+ top.exclusive top.shared) top.shared_dirty) top.dirty) top.invalid) top.__top_1))) (=> top.env (<= top.dirty 1))) (=> top.env (and (< top.dirty 1) (< top.shared 1)))) (=> top.env (>= top.shared 0))) (=> top.env (>= top.exclusive 0))) (=> top.env (>= top.shared_dirty 0))) (=> top.env (>= top.dirty 0))) (=> top.env (>= top.invalid 0))) (=> top.env (<= top.shared top.__top_1))) (=> top.env (<= top.shared_dirty top.__top_1))) (=> top.env (<= top.dirty top.__top_1))) (=> top.env (<= top.invalid top.__top_1))))
       )
  (top_step top.e01
            top.e02
            top.e03
