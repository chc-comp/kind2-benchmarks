...
(rule (=> 
  (and (= top.ni_0._arrow._first_m top.ni_0._arrow._first_c)(and (= top.__top_1 (ite top.ni_0._arrow._first_m true false))
       ...
       (and (or (not (= top.__top_1 true))
               (= top.OK true))
            (or (not (= top.__top_1 false))
               (= top.OK (or (not (and top.enable (not top.KP_CLEAR))) (or (not (and (and top.KP_6 (not top.__top_8_c)) (and (not (and top.KP_5 (not top.__top_7_c))) (and (not (and top.KP_4 (not top.__top_6_c))) (and (not (and top.KP_3 (not top.__top_5_c))) (and (not (and top.KP_2 (not top.__top_4_c))) (and (not (and top.KP_1 (not top.__top_3_c))) (not (and top.KP_0 (not top.__top_2_c)))))))))) (= top.RIGHT_DIGIT 6)))))
       )
