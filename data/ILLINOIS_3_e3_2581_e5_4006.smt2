...
(rule (=> 
  (and (excludes9_fun top.e1
       ...
       (= top.OK (=> top.env (= (+ (+ (- (- top.invalid 1) top.dirty) top.exclusive) top.shared) top.__top_1)))
       )
  (top_step top.e1
            top.e2
            top.e3
