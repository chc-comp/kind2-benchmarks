...
(rule (=> 
  (and (= top.ni_0._arrow._first_m top.ni_0._arrow._first_c)(and (= top.__top_1 (ite top.ni_0._arrow._first_m true false))
       ...
       (= top.__top_3_x top.a)
       (= top.__top_2_x top.b)
       (= top.OK (and (or (or (and (and (and (not top.a) (not top.b)) top.c) (and (and (not top.a) top.b) (not top.c))) (and (and top.a (not top.b)) (not top.c))) (and (and top.a top.b) top.c)) (not (and (and top.a top.b) top.c))))
       )
  (top_step top.x
            top.OK
            top.__top_2_c
