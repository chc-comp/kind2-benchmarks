...
(rule (=> 
  (and (excludes12_fun top.e01
       ...
       (Sofar_step (and (and (and (and (and (and (and (and (and top.__top_1 (< top.X1 32767)) (< top.X2 32767)) (< top.X3 32767)) (< top.X4 32767)) (< top.X5 32767)) (< top.X6 32767)) (< top.X7 32767)) (< top.X8 32767)) (< top.X9 32767))
                   top.env
                   top.ni_0.Sofar.__Sofar_2_m
                   top.ni_0.Sofar.ni_3._arrow._first_m
                   top.ni_0.Sofar.__Sofar_2_x
                   top.ni_0.Sofar.ni_3._arrow._first_x)
       (= top.OK (=> top.env (and (and (and (and (and (and (and (and (and (and (not top.erreur) (<= 0 top.X1)) (<= top.X1 1)) (>= top.X2 0)) (>= top.X3 0)) (>= top.X4 0)) (>= top.X5 0)) (>= top.X6 0)) (>= top.X7 0)) (>= top.X8 0)) (>= top.X9 0))))
       )
  (top_step top.e01
            top.e02
            top.e03
