...
(rule (=> 
  ...
  (and (= top.ni_0._arrow._first_m top.ni_0._arrow._first_c)(and (= top.__top_4 (ite top.ni_0._arrow._first_m true false))
       ...
       (and (or (not (= top.c true))
               (= top.y 0))
            (or (not (= top.c false))
               (and (or (not (= (and top.a (< top.pre_y 10)) true))
                       (= top.y (+ top.pre_y 1)))
                    (or (not (= (and top.a (< top.pre_y 10)) false))
                       (= top.y top.pre_y))
               ))
       )
       (and (or (not (= top.__top_4 true))
       ...
       (and (or (not (= (or top.b top.c) true))
            ...
            (or (not (= (or top.b top.c) false))
               (and (or (not (= (and top.a (< top.pre_x 15)) true))
                       (= top.x (+ top.pre_x 1)))
                    (or (not (= (and top.a (< top.pre_x 15)) false))
                       (= top.x top.pre_x))
               ))
       )
       (= top.ok (=> (= top.x 15) (= top.y 10)))
       (= top.__top_6_x top.x)
       (= top.__top_5_x top.y)
       )
