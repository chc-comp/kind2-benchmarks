...
(rule (=> 
  (and (= top.ni_0._arrow._first_m top.ni_0._arrow._first_c)(and (= top.__top_1 (ite top.ni_0._arrow._first_m true false))
       ...
       (and (or (not (= top.__top_1 true))
               (= top.p14 true))
            (or (not (= top.__top_1 false))
               (= top.p14 (or (not (and top.enable (not top.KP_CLEAR))) (= top.STEPS_TO_COOK (* (+ (+ top.RIGHT_DIGIT (* top.microwave_microwave_TIME_ON_DISPLAY_SECONDS_TO_TENS__QUOTIENT 10)) (* top.microwave_microwave_TIME_ON_DISPLAY_SECONDS_TO_MINUTES__QUOTIENT 60)) 1)))))
       )
       (and (or (not (= true true))
               (and (or (not (= top.chart_microwave_mode_logic_rlt_evtInitStep true))
       ...
       (= top.OK (and (>= top.microwave_microwave_TIME_ON_DISPLAY_SECONDS_TO_TENS__QUOTIENT 0) (<= top.microwave_microwave_TIME_ON_DISPLAY_SECONDS_TO_TENS__QUOTIENT 256)))
       )
