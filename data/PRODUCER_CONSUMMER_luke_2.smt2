...
(declare-var PRODUCER_CONSUMMER.ni_4._arrow._first_c Bool)
...
(declare-var PRODUCER_CONSUMMER.ni_4._arrow._first_m Bool)
...
(declare-var PRODUCER_CONSUMMER.ni_4._arrow._first_x Bool)
...
(rule (=> 
  (and (= PRODUCER_CONSUMMER.garde3 (>= PRODUCER_CONSUMMER.__PRODUCER_CONSUMMER_5_c 1))
       (= PRODUCER_CONSUMMER.ni_4._arrow._first_m PRODUCER_CONSUMMER.ni_4._arrow._first_c)
       (and (= PRODUCER_CONSUMMER.__PRODUCER_CONSUMMER_1 (ite PRODUCER_CONSUMMER.ni_4._arrow._first_m true false))
...
(declare-var top.ni_0.PRODUCER_CONSUMMER.ni_4._arrow._first_c Bool)
(declare-var top.ni_1.First.__First_2_c Int)
(declare-var top.ni_1.First.ni_5._arrow._first_c Bool)
...
(declare-var top.ni_0.PRODUCER_CONSUMMER.ni_4._arrow._first_m Bool)
(declare-var top.ni_1.First.__First_2_m Int)
(declare-var top.ni_1.First.ni_5._arrow._first_m Bool)
...
(declare-var top.ni_0.PRODUCER_CONSUMMER.ni_4._arrow._first_x Bool)
(declare-var top.ni_1.First.__First_2_x Int)
(declare-var top.ni_1.First.ni_5._arrow._first_x Bool)
...
(declare-rel top_reset (Int Int Int Int Int Bool Int Bool Bool Bool Int Int Int Int Int Bool Int Bool Bool Bool))
(declare-rel top_step (Bool Bool Bool Int Bool Int Int Int Int Int Bool Int Bool Bool Bool Int Int Int Int Int Bool Int Bool Bool Bool))
...
(rule (=> 
  (and (excludes3_fun top.etat1
       ...
       (and (= top.ni_1.First.__First_2_m top.ni_1.First.__First_2_c)
            (= top.ni_1.First.ni_5._arrow._first_m top.ni_1.First.ni_5._arrow._first_c)
            )
       ...
       (and (= top.ni_0.PRODUCER_CONSUMMER.__PRODUCER_CONSUMMER_2_m top.ni_0.PRODUCER_CONSUMMER.__PRODUCER_CONSUMMER_2_c)
            ...
            (= top.ni_0.PRODUCER_CONSUMMER.ni_4._arrow._first_m top.ni_0.PRODUCER_CONSUMMER.ni_4._arrow._first_c)
            )
       ...
       (= top.OK (=> (and top.__top_3 (> top.__top_1 0)) (<= (+ top.o1 top.o2) top.a)))
       )
  (top_step top.etat1
            top.etat2
            top.etat3
