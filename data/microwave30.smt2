...
(rule (=> 
  (and (= top.ni_0._arrow._first_m top.ni_0._arrow._first_c)(and (= top.__top_1 (ite top.ni_0._arrow._first_m true false))
       ...
       (and (or (not (= top.__top_1 true))
               (= top.OK (or (not (and top.enable (not top.KP_CLEAR))) (or (not top.KP_0) (= top.RIGHT_DIGIT 0)))))
            (or (not (= top.__top_1 false))
               (= top.OK (or (not (and top.enable (not top.KP_CLEAR))) (or (not (and top.KP_0 (not top.__top_2_c))) (= top.RIGHT_DIGIT 0)))))
       )
