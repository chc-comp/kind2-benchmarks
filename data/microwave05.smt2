...
(rule (=> 
  (and (= top.ni_0._arrow._first_m top.ni_0._arrow._first_c)(and (= top.__top_1 (ite top.ni_0._arrow._first_m true false))
       ...
       (and (or (not (= top.__top_1 false))
               (and (and (or (not (= top.__top_13 true))
       ...
       (and (or (not (= top.__top_1 false))
               (and (= top.p24 (or (or (not (and top.enable (not top.KP_CLEAR))) (or (or (or (or (or (or (or (or (or (and top.KP_1 (not top.__top_3_c)) (and top.KP_2 (not top.__top_4_c))) (and top.KP_3 (not top.__top_5_c))) (and top.KP_4 (not top.__top_6_c))) (and top.KP_5 (not top.__top_7_c))) (and top.KP_6 (not top.__top_8_c))) (and top.KP_7 (not top.__top_9_c))) (and top.KP_8 (not top.__top_12_c))) (and top.KP_9 (not top.__top_11_c))) (and top.KP_0 (not top.__top_2_c)))) (= top.MIDDLE_DIGIT top.__top_57_c)))
                    ...
                    (= top.p22 (or (or (not (and top.enable (not top.KP_CLEAR))) (not (or (or (or (or (or (or (or (or (or (and top.KP_1 (not top.__top_3_c)) (and top.KP_2 (not top.__top_4_c))) (and top.KP_3 (not top.__top_5_c))) (and top.KP_4 (not top.__top_6_c))) (and top.KP_5 (not top.__top_7_c))) (and top.KP_6 (not top.__top_8_c))) (and top.KP_7 (not top.__top_9_c))) (and top.KP_8 (not top.__top_12_c))) (and top.KP_9 (not top.__top_11_c))) (and top.KP_0 (not top.__top_2_c))))) (= top.MIDDLE_DIGIT top.__top_110_c)))
                    ))
            (or (not (= top.__top_1 true))
               (and (= top.p24 true)
                    (= top.p23 true)
       ...
       (and (or (not (= top.__top_1 true))
               (= top.p14 true))
            (or (not (= top.__top_1 false))
               (= top.p14 (or (not (and top.enable (not top.KP_CLEAR))) (= top.STEPS_TO_COOK (* (+ (+ top.RIGHT_DIGIT (* top.MIDDLE_DIGIT 10)) (* top.microwave_microwave_TIME_ON_DISPLAY_SECONDS_TO_MINUTES__QUOTIENT 60)) 1)))))
       )
       (and (or (not (= true true))
               (and (or (not (= top.chart_microwave_mode_logic_rlt_evtInitStep true))
       ...
       (= top.__top_57_x top.MIDDLE_DIGIT)
       ...
       (= top.OK (and (>= top.microwave_microwave_TIME_ON_DISPLAY_SECONDS_TO_MINUTES__QUOTIENT 0) (<= top.microwave_microwave_TIME_ON_DISPLAY_SECONDS_TO_MINUTES__QUOTIENT 256)))
       )
