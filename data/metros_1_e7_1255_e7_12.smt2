...
(rule (=> 
  (and (and (or (not (= hypothese.__hypothese_7_c true))
       ...
       (= hypothese.__hypothese_3 (or hypothese.__hypothese_2_c hypothese.avance))
       (and (or (not (= hypothese.__hypothese_1 true))
               (= hypothese.c 0))
            (or (not (= hypothese.__hypothese_1 false))
...
(declare-var top.ni_0.Sofar.ni_8._arrow._first_c Bool)
...
(declare-var top.ni_0.Sofar.ni_8._arrow._first_m Bool)
...
(declare-var top.ni_0.Sofar.ni_8._arrow._first_x Bool)
...
(declare-var top.pOK Bool)
(declare-var top.retard0 Bool)
(declare-var top.retard1 Bool)
(declare-rel top_reset (Bool Bool Bool Bool Bool Bool Int Int Int Bool Int Bool Bool Bool Int Bool Bool Bool Bool Bool Bool Bool Bool Bool Bool Bool Bool Bool Bool Bool Int Int Int Bool Int Bool Bool Bool Int Bool Bool Bool Bool Bool Bool Bool Bool Bool))
(declare-rel top_step (Bool Bool Bool Bool Bool Bool Bool Bool Bool Bool Int Int Int Bool Int Bool Bool Bool Int Bool Bool Bool Bool Bool Bool Bool Bool Bool Bool Bool Bool Bool Bool Bool Int Int Int Bool Int Bool Bool Bool Int Bool Bool Bool Bool Bool Bool Bool Bool Bool))
...
(rule (=> 
  (and 
       ...
       (Sofar_reset top.ni_0.Sofar.__Sofar_2_c
                    top.ni_0.Sofar.ni_8._arrow._first_c
                    top.ni_0.Sofar.__Sofar_2_m
                    top.ni_0.Sofar.ni_8._arrow._first_m)
  )
  ...
  (and (and (= top.ni_2.main.__main_2_m top.ni_2.main.__main_2_c)
       ...
       (and (or (not (= top.__top_1 true))
            ...
            (or (not (= top.__top_1 false))
               (= top.pOK (not (or (and top.__top_6_c top.retard0) (and top.__top_5_c top.avance0)))))
       )
       (= top.__top_6_x top.avance0)
       (= top.__top_5_x top.retard0)
       (and (= top.ni_0.Sofar.__Sofar_2_m top.ni_0.Sofar.__Sofar_2_c)
            (= top.ni_0.Sofar.ni_8._arrow._first_m top.ni_0.Sofar.ni_8._arrow._first_c)
            )
       (Sofar_step (and (and (and (and top.ast (< top.nB0 1)) (< top.nB1 1)) (< top.nS 1)) (< top.diff0 32767))
                   top.__top_4
                   top.ni_0.Sofar.__Sofar_2_m
                   top.ni_0.Sofar.ni_8._arrow._first_m
                   top.ni_0.Sofar.__Sofar_2_x
                   top.ni_0.Sofar.ni_8._arrow._first_x)
       (and (or (not (= top.__top_1 true))
               (= top.__top_3 true))
            (or (not (= top.__top_1 false))
               (= top.__top_3 top.__top_2_c))
       )
       (= top.__top_2_x top.pOK)
       (= top.OK (=> top.__top_4 top.__top_3))
       )
  (top_step top.B0
            top.B1
            top.S
