...
; Step rule 
(rule (=> 
  (and (= Dynamics.ni_27._arrow._first_m Dynamics.ni_27._arrow._first_c)
...
; Step rule 
(rule (=> 
  (and (= Valve.ni_20._arrow._first_m Valve.ni_20._arrow._first_c)(and (= Valve.__Valve_1 (ite Valve.ni_20._arrow._first_m true false))
...
(rule (=> 
  (and (and (= top.ni_0.BoilerController.__BoilerController_4_m top.ni_0.BoilerController.__BoilerController_4_c)
       ...
       (AND_fun (not top.pump_failure_detection_0)
                (not top.pump_failure_detection_1)
                (not top.pump_failure_detection_2)
                (not top.pump_failure_detection_3)
                top.__top_2)
       (AND_fun (not top.pump_control_failure_detection_0)
                (not top.pump_control_failure_detection_1)
                (not top.pump_control_failure_detection_2)
                (not top.pump_control_failure_detection_3)
                top.__top_1)
       (= top.OK (and (and (or (or (or (or (or (= top.mode 1) (= top.mode 2)) (= top.mode 3)) (= top.mode 4)) (= top.mode 5)) (= top.mode 6)) (=> (= top.mode 3) (and (and (and (not top.level_failure_detection) (not top.steam_outcome_failure_detection)) top.__top_2) top.__top_1))) (=> (= top.mode 3) (not top.valve))))
       )
  (top_step top.stop
            top.steam_boiler_waiting
            top.physical_units_ready
